...
\tikzset{%
  ...
  UnmannedAerialVehicleOne/.pic={%
    ...
    \path[UnmannedAerialVehicleLine]%
        ...
        --%
    cycle;%
    \draw[draw=TikzCol_UnmannedAerialVehicleLine,line width=0.6*\UnmannedAerialVehicleLineWidth](-CameraCenter)circle(0.036*\UnmannedAerialVehicleSize);%
  ...
  UnmannedAerialVehicleTwo/.pic={%
    ...
    \path[UnmannedAerialVehicleLine,line width=0.5*\UnmannedAerialVehicleLineWidth]%
        (-CorpusLT2)%
        --%
...
\tikzset{%
  ...
  AutomatedGuidedVehicleOne/.pic={%
    ...
    %
    % Cargo
    \coordinate(-Packet1-BL)at($(-L2-L2)+(-\AutomatedGuidedVehicleAngleOne+30:0.3*\AutomatedGuidedVehicleLength)$);%
