...
\SetEnumitemKey{labDKDot}{label=\labDKsymDot,leftmargin=1.0em}%
\SetEnumitemKey{labDKAst}{label=\labDKsymAst,leftmargin=1.1em}%
\SetEnumitemKey{labDKPointright}{label=\labDKsymPointright,leftmargin=1.3em}%
\SetEnumitemKey{labDKTriangle}{label=\labDKsymTriangle,leftmargin=1.2em}%
\SetEnumitemKey{labDKTriangleBl}{label=\labDKsymTriangleBl,leftmargin=1.25em}%
\SetEnumitemKey{labDKLozenge}{label=\labDKsymLozenge,leftmargin=1.1em}%
\SetEnumitemKey{labDKLozengeBl}{label=\labDKsymLozengeBl,leftmargin=1.1em}%
\SetEnumitemKey{labDKSquare}{label=\labDKsymSquare,leftmargin=1.1em}%
\SetEnumitemKey{labDKSquareBl}{label=\labDKsymSquareBl,leftmargin=1.1em}%
\SetEnumitemKey{labDKDiamondSplit}{label=\labDKsymDiamondSplit,leftmargin=1.15em}%
\SetEnumitemKey{labDKCrossA}{label=\labDKsymCrossA,leftmargin=1.2em}%
\SetEnumitemKey{labDKCrossB}{label=\labDKsymCrossB,leftmargin=1.2em}%
\SetEnumitemKey{labDKCrossC}{label=\labDKsymCrossC,leftmargin=1.2em}%
\SetEnumitemKey{labDKCrossD}{label=\labDKsymCrossD,leftmargin=1.2em}%
\SetEnumitemKey{labDKCrossE}{label=\labDKsymCrossE,leftmargin=1.2em}%
%=================================
% Label Symbols END
%================================================
%
